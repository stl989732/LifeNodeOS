...
export default function InboxMessageBody({ item, loading }: Props) {
  ...
  if (item.source === "gmail" && sanitizedHtml) {
    return (
      <div
        className="inbox-email-body max-w-none text-base leading-relaxed text-slate-800 [&_a]:break-all [&_a]:text-sky-600 [&_a]:underline [&_img]:max-w-full [&_p]:mb-3 [&_table]:max-w-full"
